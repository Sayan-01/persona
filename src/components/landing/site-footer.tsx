          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center mt-6 space-x-4">
              {socialLinks.map(({ icon: Icon, href, label }) => (
                <Button key={label} asChild variant="ghost" size="icon" className="rounded-full h-9 w-9 text-muted-foreground hover:text-foreground hover:bg-foreground/5 transition-colors">
