        ...
        subPatterns: [
          {
            name: "Fixed size",
            color: "c-purple",
            signals: ["window of size k", "subarray length k", "every k elements", "monotonocity ⭕", "no -ve numbers"],
          ...
          },
          {
            name: "Variable size",
            color: "c-purple",
            signals: ["longest/shortest", "at most k", "contiguous", "need O(n)", "monotonocity ⭕", "no -ve number"],
        ...
        subPatterns: [
          {
            name: "1D prefix",
            color: "c-green",
            signals: ["contiguous range/subarray", "range sum query", "subarray sum = k", "multiple queries", "Count subarrays -> PS + Hashmap 🟢", "exact sum 🟢", "divisible by k"],
            howTo: "Build <code>pre[i] = pre[i-1] + arr[i]</code>. Range sum <code>[l,r]</code> = <code>pre[r] - pre[l-1]</code>. For sum=k: use hashmap of prefix counts. Not Required: ✗ Positive numbers, ✗ Sorted array",
